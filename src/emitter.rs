...
pub struct Emitter<'a, 'b> {
    ...
    _stack: u32,
    _label_count: usize,
    _semantic_analyzer: SemanticAnalyzer<'a, 'b>,
}
//
// impl Emitter {
//     #[must_use]
...
//                 functions,
//                 variables: _,
//             } => self._functions(functions, writer),
//             TranslationUnit::InvalidTranslationUnit => panic!(),
//         }
//     }
//
//     fn _functions(
...
//                 // self._block(block, writer)?;
//                 Ok(())
//             }
//             Function::InvalidFunction => panic!(),
//         }
//     }
//
...
//             BinaryOperator::InvalidBinaryOperator => todo!("Not implemented"),
//         };
//         self._push("eax", writer)?;
//
//         Ok(())

...
mod analysis {
    ...
    impl<'a> SymbolTable<'a> {
        ...
        ) -> (u32, rc::Rc<VariableDescriptor<'a>>) {
        ...
        pub fn function(&self, identifier: &str) -> Option<&rc::Rc<FunctionDescriptor<'a>>> {
        ...
        pub fn global_variable(&self, identifier: &str) -> Option<rc::Rc<VariableDescriptor<'a>>> {
